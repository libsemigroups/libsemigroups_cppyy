...
class TestPartialPerm(unittest.TestCase):
    ...
    def test_richcmp(self):
        self.assertEqual(
            PartialPerm([1, 2, 3], [2, 1, 0], 5), PartialPerm([1, 2, 3], [2, 1, 0], 5)
        )
        self.assertFalse(
            PartialPerm([1, 2, 3], [2, 1, 0], 5) != PartialPerm([1, 2, 3], [2, 1, 0], 5)
        )
        self.assertFalse(
            PartialPerm([1, 2, 4], [2, 1, 0], 5) == PartialPerm([1, 2, 3], [2, 3, 0], 5)
        )
        self.assertNotEqual(
            PartialPerm([1, 2, 4], [2, 1, 0], 5), PartialPerm([1, 2, 3], [2, 3, 0], 5)
        )
        ...
        self.assertLess(PartialPerm([1, 2], [0, 1], 3), PartialPerm([2, 0], [0, 1], 3))
        self.assertFalse(
            PartialPerm([1, 2], [0, 1], 3) > PartialPerm([2, 0], [0, 1], 3)
        )
        self.assertGreater(
            PartialPerm([1, 2], [1, 2], 3), PartialPerm([1, 2], [0, 1], 3)
        )
    ...
    def test_mul(self):
        ...
        # FIXME the following works, but shouldn't
    ...
    def test_pow(self):
        ...
        self.assertEqual(
            PartialPerm([0, 3, 7, 2], [5, 7, 1, 3], 8) ** 10, PartialPerm([], [], 8)
        )
        self.assertEqual(
    ...
    def test_identity(self):
        self.assertEqual(
            PartialPerm([0, 1], [1, 0], 2).identity(), PartialPerm([0, 1], [0, 1], 2)
        )
        self.assertEqual(
    ...
    def test_repr(self):
        ...
        self.assertEqual(
            eval(PartialPerm([1, 4, 2], [2, 3, 4], 6).__repr__()),
            PartialPerm([1, 4, 2], [2, 3, 4], 6),
        )
        self.assertEqual(
            eval(PartialPerm([1, 2, 3], [2, 1, 0], 5).__repr__()),
